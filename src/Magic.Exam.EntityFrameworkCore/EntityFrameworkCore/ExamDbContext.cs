    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(ExamConsts.DbTablePrefix + "Examinations",
                    ExamConsts.DbSchema
                    );
            ...
            b.Property(x => x.Status).IsRequired().HasDefaultValue(ExaminationStatus.Undefined);
            b.Property(x => x.IsStrict).IsRequired().HasDefaultValue(ExaminationStrict.No);
            b.Property(x => x.BaseDuration).IsRequired().HasDefaultValue(60);
            b.Property(x => x.BaseScore).IsRequired().HasDefaultValue(100);
        });
